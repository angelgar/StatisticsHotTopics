...
issues_volume <- read_csv("./data_issues_volume.csv")
issues_1_20 <- read_csv("./output_issues_1_20.csv")
issues_21_70 <- read_csv("./output_issues_21_70.csv")
issues_71_170 <- read_csv("./output_issues_71_170.csv")
issues_171_270 <- read_csv("./output_issues_171_270.csv")
issues_271_370 <- read_csv("./output_issues_271_370.csv")
issues_371_520 <- read_csv("./output_issues_371_520.csv")
...
#write_csv(data_articles, "jasa_articles_dataset_complete.csv")

```

```{r}

data_test <- read_csv("jasa_articles_dataset_complete.csv")
